...
apns-priority-setting the priority of the notification (default value-10)
           ...
           Payload is constructed by combining message(data) with the type of   
           user interactions(alert,badge or sound) that are to be performed.
